...
public class PlaceholderMappingController {
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> getAvailableFields() {
        ...
        try {
            // 定义可用字段及其信息 - 与UniversalChartDataView的14个字段完全对应
            List<Map<String, Object>> fields = Arrays.asList(
                    ...
                    createFieldInfo("month", "string", "月份", "时间维度", "月份 - 用于月度趋势分析，示例: 01, 02, 12"),
                    ...
                    createFieldInfo("channel", "string", "销售渠道", "分类维度", "销售渠道 - 用于渠道分析，示例: 线上, 线下, 移动端, 电话销售"),
                    createFieldInfo("product", "string", "产品名称", "分类维度", "具体产品名称，示例: iPhone 15, MacBook Pro, iPad"),
                    ...
                    // 系统字段 (2个)
                    createFieldInfo("created_at", "datetime", "创建时间", "系统字段",
                            "记录创建时间 - 系统自动生成，示例: 2024-01-15 10:30:00"),
                    createFieldInfo("updated_at", "datetime", "更新时间", "系统字段",
                            "记录更新时间 - 系统自动维护，示例: 2024-01-15 15:45:30"));
